...
export default function ProblemEditPanel({ problem, onSave, onClose }: ProblemEditPanelProps) {
  ...
  return (
    <Dialog open onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogContent className={cn("max-h-[90vh] overflow-hidden flex flex-col bg-brand-charcoal-card border-brand-charcoal-border text-brand-offwhite", aiPanelOpen ? "max-w-6xl" : "max-w-4xl")}>
