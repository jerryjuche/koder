  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 35% 40%, color-mix(in srgb, var(--color-brand-500) 18%, transparent) 0%, transparent 65%)',
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 55% 50%, color-mix(in srgb, var(--color-brand-400) 14%, transparent) 0%, transparent 60%)',
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 50% 60%, color-mix(in srgb, var(--color-brand-700) 12%, transparent) 0%, transparent 60%)',
        }}
      />
