...
export const ContributionGraph = ({
  ...
  return (
    <ContributionGraphContext.Provider
      value={{
        data, weeks, blockMargin, blockRadius, blockSize,
        fontSize, labels, labelHeight, maxLevel, totalCount,
        weekStart, year, width, height,
      }}
    >
      <div
...
export const ContributionGraphBlock = ({
  ...
  return (
    <rect
      className={cn(
        'data-[level="0"]:fill-brand-charcoal-border',
        'data-[level="1"]:fill-brand-muted-gold/20',
        'data-[level="2"]:fill-brand-muted-gold/40',
        'data-[level="3"]:fill-brand-muted-gold/60',
        'data-[level="4"]:fill-brand-muted-gold',
        className
      )}
