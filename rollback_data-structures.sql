-- ROLLBACK — Generated: 2026-07-27 14:26:46
...
UPDATE problems SET
	statement = 'A **sorted linked list** stores its values in **non-decreasing order**, which means any duplicate values always appear **next to one another**. This property allows duplicate values to be removed efficiently in a single traversal.
